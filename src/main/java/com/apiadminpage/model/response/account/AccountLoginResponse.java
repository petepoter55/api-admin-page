...
@JsonPropertyOrder({"id", "username", "role", "firstname", "lastname", "email", "createBy", "updateBy", "createDateTime", "updateDateTime", "delFlag", "token"})
public class AccountLoginResponse {
    @JsonProperty("id")
    @ApiModelProperty(position = 0, required = true, dataType = "String", notes = "username")
    private Integer id;
    ...
    @JsonProperty("token")
    @ApiModelProperty(position = 11, required = true, dataType = "String", notes = "JWT token")
